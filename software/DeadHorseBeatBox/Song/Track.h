...
namespace Song {
	...
	private:
		...
		USHORT track_num_ = 0;
		DHMidi::MidiManager * p_midi_manager_ = 0;		// Pointer to MIDI manager to allow us to trigger MIDI notes
	...
	public:
		...
		inline void SetMidiManager(DHMidi::MidiManager * p_midi_manager) { p_midi_manager_ = p_midi_manager; }
