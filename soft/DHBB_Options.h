...
#define STEPS_PER_PATTERN 8
#define STEPS_PER_QUARTER_NOTE 4

/* -- CLOCK -- */
#define DEFAULT_TEMPO 160
#define PULSE_PER_STEP 12
#define PULSE_PER_QUARTER_NOTE (PULSE_PER_STEP * STEPS_PER_QUARTER_NOTE)
...
#define TRELLIS_NUM_OF_BUTTONS (TRELLIS_NUM_OF_GRIDS * TRELLIS_BUTTONS_PER_GRID)
#define TRELLIS_BUTTONS_PER_ROW (TRELLIS_NUM_OF_BUTTONS / TRELLIS_NUM_OF_ROWS)
